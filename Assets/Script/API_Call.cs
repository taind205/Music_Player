...
{   
    public const string REMOVE_FROM_FAVORITE_SONG = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/delete/song_from_favorite_song?idSong=**&idUser=*";
    public const string ADD_TO_FAVORITE_SONG = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/add/song_to_favorite_song?idSong=**&idUser=*";
    public const string ADD_TO_LISTEN_SONG = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/add/song_to_listen_song?idSong=**&idUser=*";
    public const string GET_RECENT_SONGS = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/get/listen_song_by_user?idUser=*";
    public const string GET_FAVORITE_SONGS = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/get/favorite_song_by_user?idUser=*";
    public const string GET_BANNER_SONGS = "https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/songs_by_playlist_on?id=*";
    public const string GET_BANNER = "https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/info/banner";
    public const string GET_SONG_INFO = "https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/info/song?id=*";
    public const string GET_SONG_LYRICS = "https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/info/source/lyric?id=*";
    public const string GET_GENRE_NAME = "https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/info/genre?id=*";
    public const string REMOVE_SONG_FROMPLAYLIST = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/delete/song_from_playlist?idSong=**&idPlaylist=*";
    public const string REMOVE_SONGS_FROMPLAYLIST = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/delete/songs_from_playlist?idPlaylist=*";
    public const string REMOVE_PLAYLIST = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/delete/user_from_playlist?idUser=**&idPlaylist=*";
    public const string GET_PLAYLIST_OFUSER = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/get/playlist_by_user?idUser=*";
    public const string SONG_BYPLAYLIST = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/song/get/songs_by_playlist?idPlaylist=*";
    public const string ADD_SONG_TOPLAYLIST = "https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/add/song_to_playlist?idSong=**&idPlaylist=*";
    public const string NEWSONG="https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/song/new-release";
    public const string TRENDSONG="https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/songs/db";
    public const string CREATE_NEW_PLAYLIST="https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/add/user_to_playlist?idUser=*";
    public const string SET_PLAYLIST_FORUSER="https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/add/user_to_playlist?idUser=*&idPlaylist=**";
    public const string CREATE_NEW_PLAYLIST_FORUSER="https://musicappapi-production-95cf.up.railway.app/pmdv/db/playlist/add/user_to_playlist?idUser=*";
    public const string GET_SOURCESONG="https://musicappapi-production-95cf.up.railway.app/pmdv/src/get/streaming/song?id=*";
    public const string SEARCH_SONG="https://musicappapi-production-95cf.up.railway.app/pmdv/src/search/multi/song?query=*";
    public const string SEARCH_ARTIST="https://musicappapi-production-95cf.up.railway.app/pmdv/src/search/multi/artist?query=*";
